...
y_loc, Ma, AOA, num_wing = 0.3, 0.5, 5, 1 # ID 1 corresponds to NACA 1410, and ID 3 corresponds to NACA 4421
...
data_fluent = []
path_fluent_data = "naca1410_U_0.3.txt"
with open(path_fluent_data, 'r') as file:
    for line in file:

        values = list(map(float, line.strip().split()))
        data_fluent.append(values)

fluent_array = np.array(data_fluent)
...
if y_loc == 0.3:
    ...
    plt.xlim(0.6, 1.4)
    plt.ylim(-0.4, 0.6)
plt.plot(fluent_data[:,0], (fluent_data[:,1]/(Ma*340)), '--', linewidth=2, label="Ref", color="m")
plt.legend(fontsize=16)
# plt.savefig('C:\\Users\86188\Desktop\de_wing\\test\curves\\v\\naca1410_0.5_5\\v_1.2.jpeg', format='jpeg', dpi=300)
# plt.savefig('C:\\Users\86188\Desktop\de_wing\\test\curves\\v\\naca1410_0.5_5\\v_1.2.tiff', format='tiff', dpi=300)
plt.show()
