...
checkpoint_file = os.path.join(data_path, "checkpoint_MLP")
...
for epoch in range(start_epoch, num_epochs):
    ...
    torch.save(model, os.path.join(data_path, "model_MLP.pth"))
    torch.save(tra_losses, os.path.join(data_path, "tra_losses_MLP.pth"))
    torch.save(val_losses, os.path.join(data_path, "val_losses_MLP.pth"))
